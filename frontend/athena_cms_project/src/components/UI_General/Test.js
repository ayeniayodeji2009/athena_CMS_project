...
export default function AdminUpdate() {
   ...
   /* Custom made Logic handling page route action status */
    ...
    useEffect(() => {
        fetch(`http://127.0.0.1:5000/content/${updateContentID}`)
            ...
            .then((data) => {
                ...
                setDatabaseImage({ "image_code": data.image_url }) //...databaseImage, 
    ...
    }, [updateContentID, setCategory, setTags, setMetaDescription]); // Changes done here

    
    console.log(databaseImage) //note this point for image page reload process
    ...
    function handleUpdate() {
        fetch(`http://127.0.0.1:5000/content/${updateContentID}`, {
            ...
            .then(() => {
                ...
                // Clear the Context API for next use aftersubmit
                setUpdateTitle()
                setUpdateBody()
                setCategory()
                setTags()
                ...
                // Clear data in local storage use aftersubmit
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if (updateImage.image_code === "" || updateImage.image_code === null || updateImage.image_code === undefined) {
            setUpdateImage({ "image_code": databaseImage.image_code}) // ...updateImage,
        } 

        // Managing page reload and retaining changed image from not getting lost
        if (navType === "reload" && databaseImage.image_code !== localUpdateImageFromLS) setUpdateImage({ "image_code": localUpdateImageFromLS})
        // else if (databaseImage.image_code && localUpdateImageFromLS && databaseImage.image_code === localUpdateImageFromLS) {
        ...
        /* Before going to Preview page(upon entering into the update page), existing preview variable is has value "undefined". 
           After leaving preview page comingback to update page, previewImage becomes an object which has value. This code is not serving its purpose*/
        ...
        if (navType === "reload") {
          ...
          //     const localUpdateImageFromLS = localStorage.getItem('localUpdateImageCopy');
          //     setUpdateImage({"image_code": localUpdateImageFromLS}) //...updateImage, 
          //   }
            console.log(updateImage)
    ...
    },[databaseBody, databaseImage.image_code, databaseTitle, navType, previewBody, previewImage, previewTitle, setUpdateBody, setUpdateImage, setUpdateTitle, updateBody, updateImage, updateTitle, content_id, updateContentID, setUpdateContentID])
    ...
    // }, [navType, setUpdateBody, setUpdateContentID, setUpdateImage, setUpdateTitle, updateBody, updateContentID, updateImage, updateTitle]) 
